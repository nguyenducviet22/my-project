				...
				<div class="col-md-6">
					...
					<div class="mb-3">
						<label for="username" class="form-label">Username<span
							...
							id="username" name="username" required="required" value="">
					</div>
					...
					<div class="mb-3">
						<label for="reenteredPassword" class="form-label">Reenter
							Password</label><span class="red">*</span><span id="msg" class="red">*</span>
						<input type="password" class="form-control" id="reenteredPassword"
							name="reenteredPassword" required="required"
							onkeyup="checkPassword()">
					</div>
					<h3>Customer info</h3>
					...
					<div class="mb-3">
						...
						<input type="date" class="form-control" id="dateOfBirth"
							name="dateOfBirth" required="required" value="">
					</div>
				</div>
				<div class="col-md-6">
					<h3>Address</h3>
					...
					<div class="mb-3">
						<label for="phoneNumber" class="form-label">Phone number</label> <input
							...
							name="phoneNumber" required="required" value="">
					</div>
